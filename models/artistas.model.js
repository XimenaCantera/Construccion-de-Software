...
module.exports = class artista {
    ...
    //Constructor de la clase. Crear un nuevo objeto, y definir sus propiedades.
    constructor(nuevo_artista) {
        this.nombre = nuevo_artista.nombre || 'Nadie';
        this.premio = nuevo_artista.premio || 'Ninguno';
        this.foto = nuevo_artista.foto || 'No puso nada';
        this.ubicacion = nuevo_artista.ubicacion || 'En ningún lado.';
        this.descripcion = nuevo_artista.descripcion || 'Muy importante';
    }

    //Gardar el nuevo objeto. 
    save() {
        artista.push(this);
    }
